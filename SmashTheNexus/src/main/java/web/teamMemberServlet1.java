...
public class teamMemberServlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		teamMember1.setTeamID(team1.getId());
		...
		teamMember2.setTeamID(team1.getId());
		...
		teamMember3.setTeamID(team1.getId());
		...
		teamMember4.setTeamID(team1.getId());
		...
		teamMember5.setTeamID(team1.getId());
