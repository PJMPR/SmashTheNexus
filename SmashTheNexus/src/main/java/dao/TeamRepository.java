...
public class TeamRepository extends RepositoryBase<Team> implements ITeamRepository{
	...
	protected String createTableSql() {
		...
		+ "name varchar(50)," + "wins int," + "loses int," + "formdate int," + "shortname varchar(5)" + ")";
	}

	@Override
	protected String insertSql() {
		return "INSERT INTO team(name, wins, loses, formdate, shortname) VALUES(?,?,?,?,?)";
	}

	@Override
	protected String updateSql() {
		return "UPDATE team SET name=?,wins=?,loses=?,formdate=?,shortname=? WHERE id=?";
	}
