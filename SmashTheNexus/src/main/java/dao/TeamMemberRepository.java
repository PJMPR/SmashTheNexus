...
public class TeamMemberRepository extends RepositoryBase<TeamMember> implements ITeamMemberRepository {
	...
	protected void setInsert(TeamMember entity) throws SQLException {
		...
		insert.setInt(4, entity.getTeam().getId());
	...
	protected void setUpdate(TeamMember entity) throws SQLException {
		...
		update.setInt(4, entity.getTeam().getId());
	...
	protected String createTableSql() {
		return "CREATE TABLE team_member(" + "id bigint GENERATED BY DEFAULT AS IDENTITY,"
				...
				+ "age int,"
				+ "country varchar(30),"
				+ "favouritechampion varchar(30)"+ ")";
	}

	@Override
	protected String insertSql() {
		return "INSERT INTO team_member(name, surname, nick, team_id, age, country, favouritechampion) VALUES(?,?,?,?,?,?,?)";
	}

	@Override
	protected String updateSql() {
		return "UPDATE team_member SET name=?,surname=?,nick=?,team_id=?,age=?,country=?,favouritechampion=? WHERE id=?";
	}
